...
var runIO = function(io) { return io.val(); };
...
var IO = function(fn) { return (new IOType(fn)); };
...
IOType.prototype.map = function(f) {
  return this.chain(function(a) { return IOType.of(f(a)); });
};
IOType.prototype.ap = function(a) {
  return this.chain(function(f) { return a.map(f); });
};
